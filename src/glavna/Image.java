...
/**
 * Input file bi trebao biti slièan:
 * 
 * CreateTraining: width:120,height:120,type:RGB 
 * Input: image:slika0.jpg, identity:happy 
 * Input: image:slika1.jpg, identity:cold 
 * Input: image:slika2.jpg, identity:cry laughter 
 * Input: image:slika3.jpg, identity:star
 * Network: hidden1:100, hidden2:0
 * Train: Mode:console, Minutes:1, StrategyError:0.25, StrategyCycles:50 
 * Whatis: image:slika0.jpg
 * Whatis: image:slika1.jpg
 * Whatis: image:slika2.jpg
 * 
 */
public class Image {
	...
	private void processNetwork() throws IOException {
		...
		for (final ImagePair pair : this.imageList) {
			...
			final java.awt.Image img = ImageIO.read(pair.getFile());
